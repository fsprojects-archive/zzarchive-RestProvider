...
let website = "/RestProvider"

let githubLink = "http://github.com/fsprojects/RestProvider"

// Specify more information about your project
let info =
  [ "project-name", "RestProvider"
    "project-author", "Tomas Petricek"
    "project-summary", "F# type provider that lets you create type providers just by implementing a simple REST service"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/RestProvider" ]
